...
#define LSM_I2C                  I2C1
#define LSM_I2C_RCC_Periph       RCC_APB1Periph_I2C1
...
#define LSM_M_I2C                 I2C1
#define LSM_M_I2C_RCC_Periph      RCC_APB1Periph_I2C1
#define LSM_M_I2C_Port            GPIOB
#define LSM_M_I2C_SCL_Pin         GPIO_Pin_6
#define LSM_M_I2C_SDA_Pin         GPIO_Pin_7
#define LSM_M_I2C_RCC_Port        RCC_APB2Periph_GPIOB

#define LSM_M_I2C_Speed           100000
/**
*@}
...
#define LSM_M_DRDY_Pin                   GPIO_Pin_8
...
#define LSM_M_DRDY_Pin_Source            GPIO_PinSource8
#define LSM_M_DRDY_EXTI_Line             EXTI_Line8
#define LSM_M_DRDY_Edge                  EXTI_Trigger_Falling
#define LSM_M_DRDY_EXTI_IRQCHANNEL       EXTI9_5_IRQChannel
...
#define LSM_A_I2C                 I2C1
#define LSM_A_I2C_RCC_Periph      RCC_APB1Periph_I2C1
#define LSM_A_I2C_Port            GPIOB
#define LSM_A_I2C_SCL_Pin         GPIO_Pin_6
#define LSM_A_I2C_SDA_Pin         GPIO_Pin_7
#define LSM_A_I2C_RCC_Port        RCC_APB2Periph_GPIOB
#define LSM_A_I2C_Speed           100000
